...
namespace InstrumentedLibrary
{
    ...
    /// 
    /// </summary>
    public static class ObliqueEllipseObliqueEllipseIntersectionAngleTests
    {
        /// <summary>
