    ...
    public static class RectanglesAreCloseTests
    {
        ...
        public static List<SpeedTester> TestHarness()
        {
            ...
            var tests = new Dictionary<object[], TestCaseResults> {
                { new object[] { new Rectangle2D(0d, 0d, 1d, 1d), new Rectangle2D(1d, 1d, 2d, 2d), DoubleEpsilon }, new TestCaseResults(description:".", trials:trials, expectedReturnValue:15d, epsilon:DoubleEpsilon) },
            };
        ...
        public static bool AreClose(Rectangle2D rect1, Rectangle2D rect2, double epsilon = DoubleEpsilon)
        {
            ...
            if (RectangleIsEmptyTests.IsEmpty(rect1.Width, rect1.Height))
            {
                return RectangleIsEmptyTests.IsEmpty(rect2.Width, rect2.Height);
            }
