...
namespace InstrumentedLibrary
{
    ...
    public static class IntersectionQuadraticBezierQuadraticBezierTests
    {
        /// <summary>
        ...
        public static List<SpeedTester> TestHarness()
        {
            ...
            var tests = new Dictionary<object[], TestCaseResults> {
                { new object[] { 0d, 5d, 10d, 15d, 20d, 5d,  0d, 5d, 10d, -5d, 20d, 5d, Epsilon }, new TestCaseResults("Circle test case.", trials, new Intersection(), double.Epsilon) },
            };
