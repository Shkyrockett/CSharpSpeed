    ...
    public static class CubicBezierLineSegmentIntersectionTests
    {
        ...
        public static List<SpeedTester> TestHarness()
        {
            ...
            var tests = new Dictionary<object[], TestCaseResults> {
                { new object[] { 0d, 5d, 10d, 15d, 20d, 0d, 5d, 10d, -5d, 20d, 10d, 30d, Epsilon }, new TestCaseResults(description:"", trials:trials, expectedReturnValue:15d, epsilon:DoubleEpsilon) },
            };
