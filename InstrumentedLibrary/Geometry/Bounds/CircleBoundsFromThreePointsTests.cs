...
namespace InstrumentedLibrary
{
    ...
    public static class CircleBoundsFromThreePointsTests
    {
        /// <summary>
        ...
        public static List<SpeedTester> TestHarness()
        {
            ...
            var tests = new Dictionary<object[], TestCaseResults> {
                { new object[] { 0d, 0d, 0d, 1d, 1d, 1d }, new TestCaseResults("Circle from three points test case.", trials, Tau, double.Epsilon) },
            };
