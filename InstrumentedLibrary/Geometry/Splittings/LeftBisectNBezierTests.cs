...
namespace InstrumentedLibrary
{
    ...
    /// 
    /// </summary>
    [DisplayName("Left Bisect Any Number Bezier")]
    [Description("Left Bisect Any Number Bezier.")]
    ...
    public static class LeftBisectNBezierTests
    {
        ...
        [DisplayName(nameof(LeftBisectNBezierTests))]
        ...
        [DebuggerStepThrough]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Point2D[] LeftBisectNBezier_(Point2D[] points, double t)
        {
            if (t < 0d || t > 1d)
            {
