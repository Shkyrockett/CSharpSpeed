...
namespace InstrumentedLibrary
{
    ...
    public static class RightBisectEllipticalArcTests
    {
        ...
        public static EllipticalArc2D RightSplitEllipticalArc(double x, double y, double rX, double rY, double angle, double startAngle, double sweepAngle, double t)
            => RightSplitEllipticalArc1(x, y, rX, rY, angle, startAngle, sweepAngle, t);
        ...
        [DebuggerStepThrough]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EllipticalArc2D RightSplitEllipticalArc1(double x, double y, double rX, double rY, double angle, double startAngle, double sweepAngle, double t)
        {
            if (t < 0d || t > 1d)
            {
