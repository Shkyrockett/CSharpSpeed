...
namespace InstrumentedLibrary
{
    ...
    public static class LeftBisectCircularArcTests
    {
        ...
        public static CircularArc2D LeftBisectCircularArc(double x, double y, double radius, double startAngle, double sweepAngle, double t)
            => LeftBisectCircularArc_(x, y, radius, startAngle, sweepAngle, t);
        ...
        [DebuggerStepThrough]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static CircularArc2D LeftBisectCircularArc_(double x, double y, double radius, double startAngle, double sweepAngle, double t)
        {
            if (t < 0d || t > 1d)
            {
