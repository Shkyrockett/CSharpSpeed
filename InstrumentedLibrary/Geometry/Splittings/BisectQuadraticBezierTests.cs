...
namespace InstrumentedLibrary
{
    ...
    public static class BisectQuadraticBezierTests
    {
        ...
        public static (QuadraticBezier2D A, QuadraticBezier2D B) BisectQuadraticBezier(double aX, double aY, double bX, double bY, double cX, double cY, double t)
            => BisectQuadraticBezier_(aX, aY, bX, bY, cX, cY, t);
        ...
        [DebuggerStepThrough]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static (QuadraticBezier2D A, QuadraticBezier2D B) BisectQuadraticBezier_(double aX, double aY, double bX, double bY, double cX, double cY, double t)
        {
