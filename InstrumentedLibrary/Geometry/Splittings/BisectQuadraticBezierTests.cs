...
namespace InstrumentedLibrary
{
    ...
    /// 
    /// </summary>
    [DisplayName("Bisect Quadratic Bezier")]
    [Description("Bisect Quadratic Bezier.")]
    ...
    public static class BisectQuadraticBezierTests
    {
        ...
        [DisplayName(nameof(BisectQuadraticBezierTests))]
        public static List<SpeedTester> TestHarness()
        {
            var trials = 1000;
            var tests = new Dictionary<object[], TestCaseResults> {
                { new object[] { 0d, 0d, 5d, 5d, 10d, 0d, 0.5d }, new TestCaseResults(description: "", trials: trials, expectedReturnValue: true, epsilon: double.Epsilon) },
            };
        ...
        public static (QuadraticBezier2D A, QuadraticBezier2D B) BisectQuadraticBezier(double aX, double aY, double bX, double bY, double cX, double cY, double t)
            => BisectQuadraticBezier1(aX, aY, bX, bY, cX, cY, t);
        ...
        [DebuggerStepThrough]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static (QuadraticBezier2D A, QuadraticBezier2D B) BisectQuadraticBezier1(double aX, double aY, double bX, double bY, double cX, double cY, double t)
        {
