...
namespace InstrumentedLibrary
{
    ...
    public static class RightBisectCircularArcTests
    {
        ...
        public static CircularArc2D RightBisectCircularArc(double x, double y, double radius, double startAngle, double sweepAngle, double t)
            => RightBisectCircularArc_(x, y, radius, startAngle, sweepAngle, t);
        ...
        [DebuggerStepThrough]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static CircularArc2D RightBisectCircularArc_(double x, double y, double radius, double startAngle, double sweepAngle, double t)
        {
            if (t < 0d || t > 1d)
            {
