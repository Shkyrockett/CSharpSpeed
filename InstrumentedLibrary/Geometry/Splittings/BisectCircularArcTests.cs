...
namespace InstrumentedLibrary
{
    ...
    public static class BisectCircularArcTests
    {
        ...
        public static (CircularArc2D A, CircularArc2D B) BisectCircularArc(double x, double y, double radius, double startAngle, double sweepAngle, double t)
            => BisectCircularArc_(x, y, radius, startAngle, sweepAngle, t);
        ...
        [DebuggerStepThrough]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static (CircularArc2D A, CircularArc2D B) BisectCircularArc_(double x, double y, double radius, double startAngle, double sweepAngle, double t)
        {
            if (t < 0d || t > 1d)
            {
