...
namespace InstrumentedLibrary
{
    ...
    public static class LineSegmentToCubicBezierTests
    {
        ...
        public static (double aX, double aY, double bX, double bY, double cX, double cY, double dX, double dY) LineSegmentToCubicBezier(
            double x0, double y0,
            double x1, double y1)
        {
            (double X, double Y) p2 = InterpolateLinear2DTests.LinearInterpolate2D_0(x0, y0, x1, y1, OneThird);
            (double X, double Y) p3 = InterpolateLinear2DTests.LinearInterpolate2D_0(x0, y0, x1, y1, TwoThirds);
