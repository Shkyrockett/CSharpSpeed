    ...
    public static class CatmullRomToCubicBezierTests
    {
        ...
        public static List<SpeedTester> TestHarness()
        {
            ...
            var tests = new Dictionary<object[], TestCaseResults> {
                { new object[] { 0d, 1d, 2d, 3d, 4d, 5d }, new TestCaseResults(description: "", trials: trials, expectedReturnValue: (0d, 1d, 0d, 1d, 1.3333333333333333d, 2.3333333333333335d, 2d, 3d) , epsilon: double.Epsilon) },
            };
