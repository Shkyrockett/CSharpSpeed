...
namespace InstrumentedLibrary
{
    ...
    /// 
    /// </summary>
    public static class MultiplyMatrix3x3x4x4Tests
    {
        /// <summary>
        ...
        {
            return ((leftM0x0 * rightM0x0) + (leftM0x1 * rightM1x0) + (leftM0x2 * rightM2x0), (leftM0x0 * rightM0x1) + (leftM0x1 * rightM1x1) + (leftM0x2 * rightM2x1), (leftM0x0 * rightM0x2) + (leftM0x1 * rightM1x2) + (leftM0x2 * rightM2x2), (leftM0x0 * rightM0x3) + (leftM0x1 * rightM1x3) + (leftM0x2 * rightM2x3),
