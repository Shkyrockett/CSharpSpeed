...
namespace InstrumentedLibrary
{
    ...
    /// 
    /// </summary>
    [DisplayName("Plus Matrix.")]
    [Description("Applies the Positive Operation to the values of a Matrix.")]
    [SourceCodeLocationProvider]
    public static class GeneralMatrixPlusTests
    {
        /// <summary>
        /// Tests the harness.
        /// </summary>
        ...
        [DebuggerStepThrough]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double[,] Plus1(double[,] augend)
        {
