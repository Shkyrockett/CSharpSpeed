...
namespace InstrumentedLibrary
{
    ...
    /// 
    /// </summary>
    public static class MultiplyMatrix2x2x3x3Tests
    {
        /// <summary>
        ...
        {
            return ((leftM0x0 * rightM0x0) + (leftM0x1 * rightM1x0), (leftM0x0 * rightM0x1) + (leftM0x1 * rightM1x1), (leftM0x0 * rightM0x2) + (leftM0x1 * rightM1x2),
