...
namespace InstrumentedLibrary
{
    ...
    public static class MatrixDeterminant5x5Tests
    {
        ...
        [Signature]
        public static double Determinant(double a, double b, double c, double d, double e, double f, double g, double h, double i, double j, double k, double l, double m, double n, double o, double p, double q, double r, double s, double t, double u, double v, double w, double x, double y)
            => Determinant0(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y);
