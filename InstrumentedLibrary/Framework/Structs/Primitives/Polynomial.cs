...
namespace InstrumentedLibrary
{
    ...
    public struct Polynomial
    {
        ...
        public double[] RootsInInterval(double min = 0, double max = 1, double epsilon = Epsilon)
        {
            ...
            if (Degree == PolynomialDegree.Constant)
            {
                return null;
            }
        ...
        public double[] Roots(double epsilon = Epsilon)
        {
            switch (Degree)
            {
                ...
                case PolynomialDegree.Quintic:
                    return QuinticRootsTests.QuinticRoots(coefficients[5], coefficients[4], coefficients[3], coefficients[2], coefficients[1], coefficients[0], epsilon).ToArray();
